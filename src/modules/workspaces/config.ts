...
export const WORKSPACE_DEFINITIONS: Record<
  WorkspaceRoute,
  WorkspaceDefinition
> = {
  "/admin": {
    ...
    description:
      "Người dùng, vai trò, thiết lập hệ thống và nhật ký kiểm soát.",
  ...
  "/executive": {
    ...
    title: "Ban lãnh đạo",
    description:
      "Dashboard lãnh đạo, kế hoạch đầu tư, chỉ đạo điều hành, họp, phê duyệt và nhật ký quyết định.",
    roles: EXECUTIVE_ROUTE_ROLES,
    permissions: [
      "project.view",
      "task.view",
      "document.view",
  ...
  "/project-workbench": {
    ...
    description:
      "Theo dõi dự án được giao, công việc, hồ sơ và điểm nghẽn pháp lý.",
  ...
  "/legal-workspace": {
    ...
    description:
      "Checklist pháp lý, bước chờ cơ quan, bước bị vướng và hồ sơ pháp lý.",
    roles: ["phap_ly"],
  ...
  "/finance-workspace": {
    ...
    description:
      "Màn hình sẵn sàng cho ngân sách, thanh toán, hợp đồng và việc tài chính.",
    roles: ["ke_toan"],
    permissions: ["finance.view", "document.view", "task.view"],
    futureNote:
      "Module tài chính đầy đủ sẽ được triển khai sau MVP; hiện tại hiển thị việc và hồ sơ liên quan.",
  },
  "/finance-management-workspace": {
    route: "/finance-management-workspace",
    title: "Không gian quản lý tài chính",
    description:
      "Dòng tiền, ngân sách, phê duyệt tài chính và hiệu quả đầu tư.",
    ...
    futureNote:
      "Module tài chính sâu sẽ mở rộng sau Proposal/Approval foundation.",
  },
  "/contract-workspace": {
  ...
  "/investment-workspace": {
    ...
    futureNote:
      "Opportunity pipeline sẽ được triển khai sau Proposal/Approval foundation.",
  },
  "/hr-workspace": {
    route: "/hr-workspace",
    title: "Không gian hành chính nhân sự",
    description:
      "Yêu cầu nhân sự, hành chính nội bộ, tuyển dụng/KPI và đề xuất HR.",
  ...
  "/quality-workspace": {
    ...
    description:
      "Checklist chất lượng, kiểm tra, NCR và cổng nghiệm thu chất lượng.",
  ...
  "/safety-workspace": {
    ...
    description:
      "Quan sát an toàn, sự cố, hành động khắc phục và tuân thủ công trường.",
  ...
  "/audit-workspace": {
    ...
    description:
      "Rà soát tài chính, quy trình, compliance và ngoại lệ kiểm soát.",
  ...
  "/design-workspace": {
    ...
    description:
      "Bản vẽ, hồ sơ thiết kế, việc review và các điểm cần cập nhật.",
    roles: ["thiet_ke"],
    permissions: ["design.view", "document.view", "task.view"],
    futureNote:
      "Module thiết kế đầy đủ sẽ mở rộng từ hồ sơ, task và quy trình review hiện có.",
  },
  "/technical-workspace": {
    route: "/technical-workspace",
    title: "Không gian kỹ thuật",
    description:
      "Việc kỹ thuật, phối hợp thiết kế/thi công và hồ sơ cần rà soát.",
    roles: ["ky_thuat"],
    permissions: [
      "task.view",
      "document.view",
  ...
  "/construction-workspace": {
    ...
    description:
      "Việc hiện trường, nhật ký, chất lượng và nghiệm thu tương lai.",
    roles: ["thi_cong"],
    permissions: ["construction.view", "task.view", "document.view"],
    futureNote:
      "Nhật ký công trường và nghiệm thu là module tương lai; màn hình này dùng dữ liệu task/document hiện có.",
  },
  "/assistant-workspace": {
    route: "/assistant-workspace",
    title: "Không gian trợ lý",
    description:
      "Hàng chờ nhập liệu, hồ sơ thiếu, meeting note và báo cáo nháp.",
    roles: ["thu_ky_tro_ly"],
  ...
  "/contractor": {
    ...
    title: "Cổng nhà thầu",
    description:
      "Chỉ hiển thị gói việc, task và hồ sơ được giao cho nhà thầu hiện tại.",
    roles: ["nha_thau"],
    permissions: ["task.view", "task.update_own", "document.view"],
  },
  "/consultant": {
  ...
  "/viewer": {
    ...
    description:
      "Tổng quan đọc-only theo quyền được cấp, không có thao tác chỉnh sửa.",
    roles: ["viewer"],
    permissions: ["project.view", "task.view", "document.view", "legal.view"],
  },
};
