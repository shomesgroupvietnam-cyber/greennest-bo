...
- **[README.md](./README.md)** - Implementation artifact folder overview
- **[sprint-status.yaml](./sprint-status.yaml)** - Story and epic status tracker
- **[deferred-work.md](./deferred-work.md)** - Deferred review follow-up work
...
- **[3-1-approval-center-scoped-queue-va-axis-tabs.md](./3-1-approval-center-scoped-queue-va-axis-tabs.md)** - Scoped approval center queue
- **[3-2-approval-detail-cho-request-truc-1.md](./3-2-approval-detail-cho-request-truc-1.md)** - Truc 1 approval detail
...
- **[spec-command-center-unification.md](./spec-command-center-unification.md)** - Command center unification spec
- **[spec-executive-command-center-architecture.md](./spec-executive-command-center-architecture.md)** - Executive command architecture spec
- **[spec-executive-dashboard-command-center.md](./spec-executive-dashboard-command-center.md)** - Executive dashboard command spec
- **[spec-one-meeting-engine-types-schema-mock-ui.md](./spec-one-meeting-engine-types-schema-mock-ui.md)** - Meeting engine schema mock UI

## Subdirectories

### investigations/

- **[chairman-dashboard-leadership-investigation.md](./investigations/chairman-dashboard-leadership-investigation.md)** - Chairman dashboard investigation
- **[module-1-brd-us-mapping.md](./investigations/module-1-brd-us-mapping.md)** - Module 1 BRD story mapping
