...
- [Architecture Decision Document](#table-of-contents)
  ...
  - [Starter Template Evaluation](./starter-template-evaluation.md)
    ...
    - [Selected Starter: Existing Next.js App Router Brownfield Baseline](./starter-template-evaluation.md#selected-starter-existing-nextjs-app-router-brownfield-baseline)
